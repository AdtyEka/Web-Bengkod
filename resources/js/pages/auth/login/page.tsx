...
// Floating particle for right panel
...
// Animated stats pill on the right panel
function StatPill({
    value,
    label,
    delay,
...
// Testimonial card on the right panel
    ...
    return (
        ...
        >
            ...
            <p className="font-sans text-[14px] leading-relaxed text-white/80 italic mb-5">
                "CV saya dari skor 58 jadi 91 setelah ikutin semua saran SynnAI. Langsung lolos ke tahap interview di 3 perusahaan."
            </p>
            <div className="flex items-center gap-3">
                <div
                    className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-white/20 font-sans text-xs font-bold text-white"
                >
                    RA
                </div>
                <div>
                    <p className="font-sans text-[13px] font-semibold text-white">Rizky Ardiansyah</p>
                    <p className="font-sans text-[11px] text-white/55">Software Engineer, Tokopedia</p>
                </div>
            </div>
        </motion.div>
    );
...
function VisualPanel() {
    ...
    return (
        <div className="relative hidden w-[55%] shrink-0 overflow-hidden lg:flex lg:flex-col lg:justify-between lg:px-14 lg:py-14">
            {/* Background — transparent, parent handles the blue */}
            ...
            >
                ...
                >
                    Selamat datang <br />
                    <span className="italic">kembali.</span>
                </h2>

                <p className="font-sans text-[15px] text-white/70 leading-relaxed max-w-xs">
                    Lanjutkan perjalananmu menuju karir impian bersama kekuatan AI.
                </p>
            </motion.div>
...
export default function Login() {
    ...
    return (
        <>
            <Head title="Masuk - SynnAI" />

            <div className="relative flex min-h-[100dvh] overflow-hidden bg-[#0871E7]">
                {/* Seamless gradient overlay — blue fades into off-white on the right */}
                <div
                ...
                {/* Right panel — 55% — visual (rendered first = left side) */}
                <VisualPanel />

                {/* Left panel — 45% — form (rendered second = right side) */}
                    ...
                    >
                        <div className="rounded-[32px] bg-white/90 border border-black/[0.05] shadow-[0_8px_48px_rgba(0,0,0,0.10)] backdrop-blur-xl px-8 py-10">
                            ...
                            <div className="mb-8">
                                ...
                                >
                                    Masuk ke <span className="italic">SynnAI</span>
                                </motion.h1>
                                <motion.p
                            ...
                            <form onSubmit={handleSubmit} className="space-y-5">
                                ...
                                >
                                    <div className="flex items-center justify-between">
                                        ...
                                        <Link
                                            ...
                                            className="font-sans text-[12px] font-medium text-[#0871E7] hover:opacity-75 transition-opacity"
                                        >
                                            Lupa password?
                                        </Link>
                                    </div>
                                ...
                                <motion.div
                                    ...
                                    initial={shouldReduce ? {} : { opacity: 0, y: 8 }}
                                    animate={{ opacity: 1, y: 0 }}
                                    transition={{ duration: 0.8, delay: 0.33, ease: EASE }}
                                >
                                    <input
                                        id="remember"
                                        type="checkbox"
                                        ...
                                        className="h-4 w-4 cursor-pointer rounded-md border-black/20 accent-[#0871E7]"
                                    />
                                    <label
                                        htmlFor="remember"
                                        className="cursor-pointer font-sans text-[13px] text-[#1a1a1a]/60"
                                    >
                                        Tetap masuk
                                    </label>
                                </motion.div>
