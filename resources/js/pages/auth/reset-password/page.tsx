...
import { ArrowLeft, ArrowRight, CheckCircle, KeyRound, Mail, Lock } from 'lucide-react';
...
export default function ResetPassword({ token, email }: { token: string; email: string }) {
    ...
    return (
        <>
            <Head title="Reset Password — SkillSync AI" />
                        ...
                        <div className="w-full max-w-sm">
                            ...
                            <form onSubmit={handleSubmit} className="mt-8 space-y-5">
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h2 className="text-base font-bold text-gray-900">Create new password</h2>
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <div className="relative">
                                        ...
                                        <Input
                                            ...
                                            readOnly
                                            value={data.email}
                                            className="h-11 rounded-xl border-gray-200 bg-gray-100 text-gray-500 pl-10"
                                        />
                                    </div>
